...
public class mainApp {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < _adList.getArray().size(); ++i) {
      _adList.get(i).construct(codeMem.get(_adList.get(i).getTypeCode()));
      carrierMem.get(codeMem.get(_adList.get(i).getTypeCode()).getCarrierVAT()).add(_adList.get(i));
      productMem.get(_adList.get(i).getProductCode()).add(_adList.get(i));
    }
